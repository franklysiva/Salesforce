...
public class EditOpportunity {
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@class='slds-media__body'])[7]"))).click();
	Thread.sleep(2000);
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//label[contains(text(),'Installation Status')]//following::div//span[@class='slds-media__body'])[2]"))).click();
	...
	Thread.sleep(5000);
	String currentStage = driver.findElement(By.xpath("(//table//tr[1]/td)[5]")).getText();
