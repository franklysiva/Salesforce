...
public class CreateNewOppurtunity {
	...
	new WebDriverWait(driver, Duration.ofMinutes(1))
		.until(ExpectedConditions.elementToBeClickable(By.xpath("//label[text()='Opportunity Name']//following::input")))
	...
	new WebDriverWait(driver,  Duration.ofMinutes(1))
		.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@class='slds-media__body'])[4]"))).click();
	driver.findElement(By.xpath("//button[@name='SaveEdit']")).click();
	WebElement createdName = new WebDriverWait(driver, Duration.ofMinutes(1))
			.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1//slot")));
